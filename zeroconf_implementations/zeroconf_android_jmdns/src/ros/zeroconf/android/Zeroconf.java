...
public class Zeroconf implements ServiceListener, ServiceTypeListener, NetworkTopologyListener {
    ...
    public void addListener(String service_type, String domain) {
        ...
        android.util.Log.i("zeroconf","Activating listener" + service);
    ...
    public void removeListener(String service_type, String domain) {
    	...
    	for ( Iterator<String> listener = listeners.iterator(); listener.hasNext(); ) {
    		...
    		if ( this_listener.equals(listener_to_remove) ) { 
                android.util.Log.i("ros","Deactivating listener: "+this_listener);
    ...
    public void addService(String name, String type, String domain, int port, String description) {
        ...
        android.util.Log.i("zeroconf","Registering service: " + full_service_type);
    ...
    public void removeAllServices() {
        android.util.Log.i("zeroconf","Removing all services");
    ...
    public void display(ServiceInfo service_info) {
        android.util.Log.i("zeroconf","Service Info: ");
    	android.util.Log.i("zeroconf","  Name   : " + service_info.getName() );
    	android.util.Log.i("zeroconf","  Type   : " + service_info.getType() );
    	android.util.Log.i("zeroconf","  Port   : " + service_info.getPort() );
    	...
    	for ( int i = 0; i < service_info.getInetAddresses().length; ++i ) {
        	android.util.Log.i("zeroconf","  Address: " + service_info.getInetAddresses()[i].getHostAddress() );
	...
	public void inetAddressAdded(NetworkTopologyEvent event) {
       	android.util.Log.i("zeroconf","[+] NetworkInterface: " + event.getInetAddress().getHostAddress());
		//System.out.printf("[+] NetworkInterface: %s\n", event.getInetAddress().getHostAddress());
        try {
        	event.getDNS().addServiceTypeListener(this);
        	for(String listener : listeners ) {
        		android.util.Log.i("zeroconf","      Adding service listener: " + listener);
        		//System.out.printf("      Adding service listener '%s'\n",listener);
            	event.getDNS().addServiceListener(listener, this);
        	}
        	for (ServiceInfo service : services ) {
            	android.util.Log.i("zeroconf","Publishing Service on " + event.getInetAddress().getHostAddress());
            	android.util.Log.i("zeroconf","  Name   : " + service.getName() );
            	android.util.Log.i("zeroconf","  Type   : " + service.getType() );
            	android.util.Log.i("zeroconf","  Port   : " + service.getPort() );
	...
	public void inetAddressRemoved(NetworkTopologyEvent event) {
    	...
    	for(String listener : listeners ) {
    		android.util.Log.i("zeroconf","      Removing service listener: " + listener);
    		//System.out.printf("      Removing service listener '%s'\n",listener);
    		event.getDNS().removeServiceListener(listener, this);
    	}
    	for (ServiceInfo service : services ) {
	    	android.util.Log.i("zeroconf","Unpublishing Service:");
	    	android.util.Log.i("zeroconf","  Name   : " + service.getName() );
	    	android.util.Log.i("zeroconf","  Type   : " + service.getType() );
	    	android.util.Log.i("zeroconf","  Port   : " + service.getPort() );
    ...
    public void serviceAdded(ServiceEvent event) {
        ...
        android.util.Log.i("zeroconf","[+] Service         : " + service_info.getQualifiedName());
    ...
    public void serviceRemoved(ServiceEvent event) {
        ...
        android.util.Log.i("zeroconf","[-] Service         : " + name);
    ...
    public void serviceResolved(ServiceEvent event) {
        final String name = event.getName();
        android.util.Log.i("zeroconf","[+] Resolved Service: " + name);
