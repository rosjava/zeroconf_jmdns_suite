 ...
 */
public class BrowserOriginal extends JFrame implements ServiceListener, ServiceTypeListener, ListSelectionListener {
    /**
     *
     */
    ...
    public static void main(String argv[]) throws IOException {
        new BrowserOriginal(JmmDNS.Factory.getInstance());
    }
}