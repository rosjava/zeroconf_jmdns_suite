...
def new_service_callback(jid):
    print "New service"
    
def remove_service_callback(jid):
    print "Remove service"

def name_conflict_callback(alt_name):
    print "Name conflict"
...
if __name__ == '__main__':
    ...
    zeroconf = Zeroconf(new_service_callback, 
                        remove_service_callback, 
                        name_conflict_callback, 
    ...
    zeroconf.connect_dbus()
    zeroconf.connect_avahi()
    zeroconf.announce()
